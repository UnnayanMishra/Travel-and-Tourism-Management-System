...
public class BookPackage extends JFrame implements ActionListener {
    ...
    String username ;
    JLabel labelusername ,labelid , labelnumber ,labelphone , labelpersons , labelprice;
    ...
    BookPackage(String username){
        ...
        labelpersons.setBounds(250,230,150,25);
        add(labelpersons);
        ...
        try{
          ...
          while(rs.next()){
            ...
            labelpersons.setText(rs.getString("number"));
        ...
        bookpackage = new JButton ("Book Packaage ");
    ...
    public void actionPerformed(ActionEvent ae ){
        if(ae.getSource()== checkprice){
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("insert into bookpackage values('"+labelusername.getText()+"' , '"+cpackage.getSelectedItem()+"', '"+tfpersons.getText()+"' , '"+labelid.getText()+"' , '"+labelpersons.getText()+"','"+labelphone.getText()+"', '"+labelprice.getText()+"')");
